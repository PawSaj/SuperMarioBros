...
public class Bowser extends Entity {
	...
	/**
	 * Metoda tworzaca p³omienie wystrzelane przez Bowsera.
	 */
	private void fire() {
		if (facing == Facing.left)
	...
	/**
	 * Metoda wyznaczaj¹ca losow¹ drogê jak¹ ma pokonaæ Bowser.
	 */
	...
	/**
	 * Metoda wyznacaj¹ca losowy czas do skoku Bowsera.
	 */
	...
	/**
	 * Metoda wyznaczaj¹ca losowy czas wystrzeliwanych p³omieni.
	 */
